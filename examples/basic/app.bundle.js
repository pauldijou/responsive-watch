...
/***/ function(module, exports, __webpack_require__) {
	...
	var _responsiveWatch = __webpack_require__(2);
	...
	(0, _responsiveWatch2['default'])(options, function (status) {
	  var html = '<h1>Basic example</h1>';
	  ...
	  ['lowDPI', 'mediumDPI', 'highDPI'].forEach(function (dpi) {
	  ...
	  ['lt', 'lte', 'gte', 'gt'].forEach(function (comp) {
