...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxAct = __webpack_require__(175);

	var _responsiveWatch = __webpack_require__(180);

	var _responsiveWatch2 = _interopRequireDefault(_responsiveWatch);

	// Flux configuration
	var updateMedias = _reduxAct.createAction('Media queries have changed');

	var reducer = _reduxAct.createReducer((_createReducer = {}, _createReducer[updateMedias] = function (state, status) {
	  return status;
	}, _createReducer), {});

	var store = _redux.createStore(_redux.combineReducers({
	  media: reducer
	...
	var options = {
	  sizes: [{ name: 'xsmall', breakpoint: 34, unit: 'em' }, { name: 'small', breakpoint: 48, unit: 'em' }, { name: 'medium', breakpoint: 62, unit: 'em' }, { name: 'large', breakpoint: 75, unit: 'em' }, { name: 'xlarge' }],
	  queries: {
	...
	_responsiveWatch2['default'](options, updateMedias);
	...
	var Item = (function (_Component) {
	  ...
	  var _Item = Item;
	  Item = _reactRedux.connect(function (state) {
	...
	var App = (function (_Component2) {
	  ...
	  App.prototype.render = function render() {
	    var status = this.props.media;

	    var sizes = options.sizes.map(function (size) {
	      return _react2['default'].createElement(
	        Item,
	        { key: size.name, active: status.sizes[size.name] },
	        size.name
	      );
	    });

	    var comparators = ['lt', 'lte', 'gte', 'gt'].map(function (comp) {
	      var compSizes = options.sizes.map(function (size) {
	        return _react2['default'].createElement(
	          Item,
	          { key: size.name, active: status[comp][size.name] },
	          size.name
	        );
	      });
	      ...
	      return _react2['default'].createElement(
	        'ul',
	        { key: comp },
	        _react2['default'].createElement(Item, { key: 'title', title: comp }),
	        compSizes
	      );
	    });
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'p',
	        null,
	        'Try to resize your browser and enjoy the show.'
	      ),
	      _react2['default'].createElement(
	        'section',
	        null,
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            Item,
	            { active: status.orientations.portrait },
	            'Portrait'
	          ),
	          _react2['default'].createElement(
	            Item,
	            { active: status.orientations.landscape },
	            'Landscape'
	          )
	        )
	      ),
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            Item,
	            { active: status.queries.lowDPI },
	            'Low DPI'
	          ),
	          _react2['default'].createElement(
	            Item,
	            { active: status.queries.mediumDPI },
	            'Medium DPI'
	          ),
	          _react2['default'].createElement(
	            Item,
	            { active: status.queries.highDPI },
	            'High DPI'
	          )
	        )
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindAll = __webpack_require__(176);

	exports.bindAll = _interopRequire(_bindAll);

	var _createAction = __webpack_require__(177);
	...
	function bindAll(actions, stores) {
	  if (Array.isArray(actions)) {
	    ...
	    Object.keys(actions).forEach(function (key) {
	      return actions[key].bindTo(stores);
	    });
	    return actions;
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createAction(name) {
	  var mapper = arguments.length <= 1 || arguments[1] === undefined ? identity : arguments[1];
	  ...
	  var actionStores = undefined;

	  function setupPayload(payload) {
	    var _ref;

	    return (_ref = {}, _defineProperty(_ref, _constants.ID, action.id), _defineProperty(_ref, 'type', action.type), _defineProperty(_ref, 'payload', payload), _ref);
	  }
	  ...
	  function actionCreator() {
	    ...
	    var payloaded = setupPayload(mapper.apply(undefined, args));

	    if (Array.isArray(actionStores)) {
	      return actionStores.map(function (store) {
	        return store.dispatch(payloaded);
	      });
	  ...
	  actionCreator.bindTo = function (stores) {
	    actionStores = stores;
	...
	function createReducer(handlers, defaultState) {
	  ...
	  function reduce(state, action) {
	    ...
	    if (action[_constants.ID] && handlers[action[_constants.ID]]) {
	      return handlers[action[_constants.ID]](state, opts.payload ? action.payload : action);
	    } else {
	      return state;
	    }
	  };
